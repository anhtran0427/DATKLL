...
REM
REM Generated by Vivado on Tue Jan 07 16:23:40 +0700 2025
...
call xsim  main_func_synth -key {Post-Synthesis:sim_1:Functional:main} -tclbatch main.tcl -log simulate.log
